                    ...
                    case 5:
                        {
                            ...
                            for (int i = 0; i < studentCounter; i++)
                            {
                                ...
                                {
                                    Student human = (Student)student[i];
                                    human.Print();
                                }
                            }
                            Console.WriteLine("\nНажимайте на любую клавишу\n");
                    ...
                    case 7:
                        {
                            ...
                            {
                                Student human2 = (Student)student[studentIndex];
                                if(student[studentIndex] == null)
                                {
                                    Console.WriteLine("Данный студент уже не учится у нас");
                                }
                                else
                                {
                    ...
                    case 8:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Console.WriteLine("Данный аспирант у нас уже не учится");
                                }
                                else
                                {
                    ...
                    case 9:
                        {
                            ...
                            {
                                Student human3 = (Student)student[deletteStudent];
